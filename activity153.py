...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        if not conversation_history:
            print(f"{Fore.YELLOW}No Convertation history yet. {Style.RESET_ALL}")
        else:
            print(f"{Fore.CYAN}📜 Converstion History:{Style.RESET_ALL}")
        ...
        print(f"{color}{emoji} {sentiment_type} sentiment detected! "
              f"(Ploarity: {polarity:2f}){Style.RESET_ALL}")